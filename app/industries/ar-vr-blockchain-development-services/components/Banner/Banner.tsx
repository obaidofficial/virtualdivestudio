            ...
            <div className="flex justify-center flex-col w-full h-full items-center gap-3">
              <p className="flex items-center gap-3 font-light">
                ...
                <span className="text-white">
                  Ar Vr Blockchain Development Services{" "}
                </span>
              </p>
              ...
              <p className="text-white text-[15px] lg:text-[18px] font-light tracking-[0.17px] text-center w-full md:w-[800px]">
                Drive innovation with our AR/VR blockchain development; we
                specialize in crafting cutting-edge decentralized applications
                and seamless integrations to uniquely enhance your digital
                landscape.
              </p>
              <Link href="/contact">
