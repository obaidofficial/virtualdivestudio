            ...
            <div className="flex justify-center flex-col w-full h-full items-center gap-3">
              <p className="flex items-center gap-3 font-light">
                ...
                <span className="text-white">
                  Social Networking And Ar Vr Entertainment Solutions{" "}
                </span>
              </p>
              ...
              <p className="text-white text-[15px] lg:text-[18px] font-light tracking-[0.17px] text-center w-full md:w-[800px]">
                Technology is reshaping socializing and entertainment, making
                connections effortless and immersive with apps and virtual
                reality. Join us and be part of a community that's redefining
