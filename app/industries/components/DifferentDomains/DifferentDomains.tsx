    ...
    <div className="bg-[#170012] pt-16 pb-16">
      <div className="pt-4 w-[94%] lg:w-[90%] mx-auto pb-4">
        <div className="grid lg:grid-cols-12 gap-2 lg:gap-4">
          ...
          <div className="lg:col-span-3 py-8 px-8 flex flex-col justify-center h-[150px] md:h-[200px] items-center border border-[#5f0055] rounded-xl bg-[#5f0055]">
            <GiGamepad className="w-18 h-18" />
          ...
          <div className="lg:col-span-3 py-8 px-8 flex flex-col justify-center h-[150px] md:h-[200px] items-center border border-[#5f0055] rounded-xl bg-[#5f0055]">
            <GiClockwork className="w-18 h-18" />
            <h4 className="text-[20px] font-semibold md:text-[24px] pt-3 text-[#ffffff] leading-[1.3em] tracking-[0.1px]">
              On-time Delivery
            </h4>
          </div>
          ...
          <div className="lg:col-span-3 py-8 px-8 flex flex-col justify-center h-[150px] md:h-[200px] items-center border border-[#5f0055] rounded-xl bg-[#5f0055]">
            <GiLockedBox className="w-18 h-18" />
            <h4 className="text-[20px] font-semibold md:text-[24px] pt-3 text-[#ffffff] leading-[1.3em] tracking-[0.1px]">
          ...
          <div className="lg:col-span-3 py-8 px-8 flex flex-col justify-center h-[150px] md:h-[200px] items-center border border-[#5f0055] rounded-xl bg-[#5f0055]">
            <GiEyeTarget className="w-18 h-18" />
            <h4 className="text-[20px] font-semibold md:text-[24px] pt-3 text-[#ffffff] leading-[1.3em] tracking-[0.1px]">
          ...
          <div className="lg:col-span-3 py-8 px-8 flex flex-col justify-center h-[150px] md:h-[200px] items-center border border-[#5f0055] rounded-xl bg-[#5f0055]">
            <GiNetworkBars className="w-18 h-18" />
            <h4 className="text-[20px] font-semibold md:text-[24px] pt-3 text-[#ffffff] leading-[1.3em] tracking-[0.1px]">
