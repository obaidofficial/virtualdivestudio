    ...
    <div className="group relative flex flex-col bg-[#320127] rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-[#ef41de]">
      ...
      <div className="p-6 flex flex-col grow">
        ...
        <Link
          ...
          className="inline-flex items-center justify-center px-5 py-3 rounded-lg tracking-[0.17px] font-medium text-white bg-[#ef41de] hover:bg-[#ce38bf] transition-colors shadow-sm group/btn"
        >
