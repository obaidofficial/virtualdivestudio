          ...
          <div className="md:w-[88%] w-[92%]">
            <div className="flex justify-center flex-col w-full h-full items-center gap-3">
              ...
              <p className="text-white text-[15px] lg:text-[18px] font-light tracking-[0.17px] text-center w-full md:w-[800px]">
                Technology is revolutionizing health and wellness, from apps
                that track steps and sleep to wearables monitoring heart rates
                and activity. With telemedicine and online fitness classes, we
                make it easier to manage health, promoting a happier, healthier
                life.
              </p>
              <Link href="/contact">
