        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-2 lg:gap-2">
          ...
          <div className="lg:col-span-6 py-2.5 px-4 flex flex-col justify-center">
            <h2 className="text-[28px] md:text-[32px] lg:text-[42px] text-white tracking-[0.5px] leading-[1.1em]">
              Transform the Social Networking industry with Virtual Dive Studios
            </h2>
            <p className="text-white text-[16px] lg:text-[20px] font-light tracking-[0.17px] mt-4">
              Technology is advancing in social networking and entertainment
              areas, hence the exciting changes in how we interact with each
              other. Team up with us and be a part of the change that is going
              to take place in social networking in the digital age.
            </p>
            <div className="mt-4">
              <Link href="/contact">
