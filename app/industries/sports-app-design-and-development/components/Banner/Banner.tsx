            ...
            <div className="flex justify-center flex-col w-full h-full items-center gap-3">
              <p className="flex items-center gap-3 font-light">
                ...
                <span className="text-white">
                  Sports App Design And Development{" "}
                </span>
              </p>
              ...
              <p className="text-white text-[15px] lg:text-[18px] font-light tracking-[0.17px] text-center w-full md:w-[800px]">
                Technology reshapes sports and lifestyle, and we provide the
                advanced tools and analytics that enhance athlete performance
                and simplify daily routines with wearable tech and apps—making
                life more engaging, efficient, and interconnected.
              </p>
              <Link href="/contact">
