            ...
            <div className="flex justify-center flex-col w-full h-full items-center gap-3">
              <p className="flex items-center gap-3 font-light">
                ...
                <span className="text-white">
                  Ar Travel App Development Services{" "}
                </span>
              </p>
              ...
              <p className="text-white text-[15px] lg:text-[18px] font-light tracking-[0.17px] text-center w-full md:w-[800px]">
                Technology simplifies travel, from booking flights and hotels
                with a few taps to navigating and overcoming language barriers
                with apps. Join us as we lead the charge in transforming travel
                into a safer, more thrilling experience.
              </p>
              <Link href="/contact">
