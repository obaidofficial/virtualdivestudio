...
const TransformEducationIndustry = () => {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-2 lg:gap-2">
          ...
          <div className="lg:col-span-6 py-2.5 px-4 flex flex-col justify-center">
            <h2 className="text-[28px] md:text-[32px] lg:text-[42px] text-white tracking-[0.5px] leading-[1.1em]">
              Transform the Education Industry with Virtual Dive Studios
            </h2>
            <p className="text-white text-[16px] lg:text-[20px] font-light tracking-[0.17px] mt-4">
              Technology is allowing education to move forward at a fast pace
              and thus, exciting changes are being brought in the way we enjoy
              learning experiences. Cooperate with us and be a part of the
              journey to change learning and education in the digital era.
            </p>
            <div className="mt-4">
              <Link href="/contact">
...
export default TransformEducationIndustry;
